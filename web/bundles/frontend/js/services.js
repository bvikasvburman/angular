...
factory('Hello', ['$resource', 'TokenHandler', function($resource, tokenHandler) {
    var resource = $resource('/angular/web/app_dev.php/api/hello');
    resource = tokenHandler.wrapActions(resource, ['get']);
    return resource;
}]).

// factory('List', ['$resource', 'TokenHandler', function($resource, tokenHandler) {
//     var resource = $resource('/angular/web/app_dev.php/api/list');
//     resource = tokenHandler.wrapActions(resource, ['get']);
//     return resource;
// }]).
...
factory('Add', ['$resource', 'TokenHandler', function($resource, tokenHandler){
    var resource = $resource('/angular/web/app_dev.php/api/add', {}, { 
...
factory('Todos', ['$resource', 'TokenHandler', function($resource, tokenHandler){
    var resource = $resource('/angular/web/app_dev.php/api/todos', {}, { 
        query: {method:'GET', params:{}, isArray:true}
    });
    resource = tokenHandler.wrapActions(resource, ['get', 'query']);
    return resource;
...
factory('Todo', ['$resource', 'TokenHandler', function($resource, tokenHandler){
    var resource = $resource('/angular/web/app_dev.php/api/todo', {}, { 
        update: {method:'PUT'},
    });
